          ...
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 2 }}>
              ...
              <div style={{ display: "flex", gap: 16, justifyContent: "center", alignItems: "center" }}>
                <button onClick={() => window.scrollTo({top: document.body.scrollHeight, behavior: 'smooth'})} style={{ padding: "14px 36px", borderRadius: 14, border: "2px solid transparent", background: C.primary, color: "#fff", fontFamily: C.font, fontSize: 16, fontWeight: 800, cursor: "pointer", boxShadow: `0 4px 16px ${C.primary}40`, transition: 'transform 0.2s', lineHeight: 1.5 }} onMouseEnter={e=>e.currentTarget.style.transform='translateY(-2px)'} onMouseLeave={e=>e.currentTarget.style.transform='none'}>Demo Talep Et</button>
                <button onClick={() => {const el = document.getElementById('pricing'); if(el) el.scrollIntoView({behavior: 'smooth'})}} style={{ padding: "14px 32px", borderRadius: 14, border: "2px solid rgba(255,255,255,0.2)", background: "transparent", color: "#f8fafc", fontFamily: C.font, fontSize: 16, fontWeight: 700, cursor: "pointer", transition: 'background 0.2s', lineHeight: 1.5 }} onMouseEnter={e=>e.currentTarget.style.background='rgba(255,255,255,0.05)'} onMouseLeave={e=>e.currentTarget.style.background='transparent'}>Fiyatları Gör ↓</button>
              </div>
            </div>
          </div>
