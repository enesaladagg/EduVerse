    ...
    <>
      ...
      <div className="login-container" style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              {[
                ...
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  ...
                  <span style={{ color: isDark ? '#cbd5e1' : '#334155', fontWeight: 500 }}>{text}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <label style={{ display: 'flex', alignItems: 'center', gap: 8, cursor: 'pointer' }}>
                ...
                />
                <span style={{ fontSize: 14, color: isDark ? '#cbd5e1' : '#475569', fontWeight: 500 }}>
                  Beni Hatırla
                </span>
              </label>
            ...
            >
              {loading ? (
                <>
                  <Loader2 size={20} className="spin" /> Giriş Yapılıyor...
                </>
              ) : (
                <>
          ...
          {/* Register Link */}
          <div style={{ marginTop: 32, textAlign: 'center', fontSize: 15, color: isDark ? '#94a3b8' : '#64748b' }}>
            Hesabınız yok mu?{' '}
      ...
      {/* Global CSS for spinner if not exists */}
      <style>{`
